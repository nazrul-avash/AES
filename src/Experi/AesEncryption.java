...
public class AesEncryption {
        ...
        {/*This is a implementation of  AES-128.
           BOTH KEY AND PLAINTEXT/CIPHERTEXT MUST BE IN HEXADECIMAL FORMAT OF 128 BIT/32 CHARACTER*/
            int selector=-1;
            ...
            try{
                ...
                System.out.println("PLEASE,enter 1 for encryption, 2 for decryption");
                selector = scan.nextInt();
                scan.nextLine();
                int keysizecheck = 128; 
                System.out.println("enter 128bit key in hexadecimal: ");
                key = scan.nextLine();
            ...
            catch (Exception e)
            {
                ...
                System.out.println("key size hasnot matched with required 32 hexa charachter/128bit");
                System.exit(1);
            }
            ...
            if (selector==1)
            {
                System.out.println("enter 128 plaintext in hexadecimal: ");
                ...
                while (plaintext != null) {
                    if (plaintext.matches("[0-9A-Fa-f]+")) //checks if plaintext is valid hex string.
                    {
                        ...
                        plaintext=null;//this line breaks the loop.
                    }
                    else
                    {
                        System.out.println("plaintext input error,please insert again in hexadecimal format(32 hexa character precisely)");
                        plaintext = scan.nextLine();
                    }
                }
            ...
            else if (selector==2) //Decryption
                
            {   System.out.println("enter ciphertext-32 hexa character: ");
                ...
                while (ciphertext != null) {
                    if (ciphertext.matches("[0-9A-Fa-f]+")){
                        if (ciphertext.length() < 32) {
                            ...
                            ciphertext = String.format("%032x",Integer.parseInt(ciphertext, 16));
                        }
                    state = new int[4][4];
                    ...
                    ciphertext=null;
                        ...
                        System.out.println("ciphertext error");
                        ciphertext = scan.nextLine();
                    }
                }
            ...
            {
                System.out.println("insert only integer 1 or 2.");
            }
        }
       ...
       /* private void deepCopy2DArray(int[][] destination, int[][] source)
        ...
        public int[][] keySchedule(String key)
        {
            ...
            int colsize = 176 ; //size of key scheduling will be based on the binary size of the key.
            ...
            for (int i = 0; i < keycounter; i++) //the first 1 (128-bit key)  set(s) of 4x4 matrices are filled with the key.
            {
                for (int j = 0; j < 4; j++) {
        ...
        public static String MatrixToString(int[][] m) //this method converts matrix elements into a single string.
        {
            String str = "";
            for (int i = 0; i < m.length; i++) {
                for (int j = 0; j < m[0].length; j++) {
                    String temp = Integer.toHexString(m[j][i]).toUpperCase();
                    if (temp.length() == 1) {
                        str += '0' + temp;
                    } else {
                       str += temp;
